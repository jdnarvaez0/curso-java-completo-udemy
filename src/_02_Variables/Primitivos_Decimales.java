...
public class Primitivos_Decimales {
    public static void main(String[] args) {
        // float, se agrega la F al final, el decimal es un .
        // Notación científica -> 1.5e-10f = 0.00000000015f
        float realFloat = 2.12F; // Example value, original was too large for float
        ...
        double realDouble = 3.4028235E38; // Example value, original was too large for double
