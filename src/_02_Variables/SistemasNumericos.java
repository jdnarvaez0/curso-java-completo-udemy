...
public class SistemasNumericos {
    public static void main(String[] args) {
        ...
        String mensajeBinario = "numero binario de " + numeroDecimal + " = "
        ...
        String mensajeOctal = "numero octal de " + numeroDecimal + " = "
        ...
        String mensajeHexadecimal = "hexadecimal de " + numeroDecimal + " = "
